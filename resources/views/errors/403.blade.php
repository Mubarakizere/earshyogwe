<x-guest-layout>
    <div class="text-center py-10">
        <h1 class="text-9xl font-black text-brand-600 drop-shadow-md">403</h1>
        <h2 class="mt-6 text-2xl font-bold text-gray-900 tracking-tight sm:text-3xl">Access Forbidden</h2>
        <p class="mt-4 text-base text-gray-600">Sorry, you don't have permission to access this page.</p>
