        ...
        <div x-data="{ open: {{ request()->routeIs('churches.*') || request()->routeIs('departments.*') || request()->routeIs('activities.*') || request()->routeIs('evangelism-reports.*') || request()->routeIs('attendances.*') || request()->routeIs('members.*') ? 'true' : 'false' }} }" class="space-y-1">
            ...
            <div x-show="open" x-collapse class="space-y-1 pl-9">
                ...
                @canany(['view all activities', 'view assigned activities', 'view own activities'])
                    <a href="{{ route('activities.index') }}" class="group flex items-center px-2 py-2 text-sm font-medium rounded-md hover:text-white hover:bg-brand-800 {{ request()->routeIs('activities.*') && !request()->routeIs('activities.custom-fields.*') ? 'text-white bg-brand-800' : 'text-brand-200' }}">
                        Activities
                    </a>
                @endcanany
                @can('manage custom fields')
                    <a href="{{ route('activities.custom-fields.index') }}" class="group flex items-center px-2 py-2 text-sm font-medium rounded-md hover:text-white hover:bg-brand-800 {{ request()->routeIs('activities.custom-fields.*') ? 'text-white bg-brand-800' : 'text-brand-200' }}">
