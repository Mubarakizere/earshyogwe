    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-lg shadow-lg p-8 mb-8 text-white">
                ...
                <p class="text-blue-100">Diocese Administrator - Full System Access</p>
            </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-3xl font-bold text-gray-900">{{ $stats['total_churches'] }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white overflow-hidden shadow-lg rounded-lg hover:shadow-xl transition-shadow duration-300">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    <dt class="text-sm font-medium text-gray-500 truncate">Pastors</dt>
                                    <dd class="text-3xl font-bold text-gray-900">{{ $stats['total_pastors'] }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white overflow-hidden shadow-lg rounded-lg hover:shadow-xl transition-shadow duration-300">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    <dt class="text-sm font-medium text-gray-500 truncate">Archids</dt>
                                    <dd class="text-3xl font-bold text-gray-900">{{ $stats['total_archids'] }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-white overflow-hidden shadow-lg rounded-lg">
                <div class="px-6 py-5 border-b border-gray-200">
                    <h3 class="text-lg font-semibold text-gray-900">Recent Churches</h3>
                </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Archid</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-200">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-500">{{ $church->location }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">{{ $church->pastor->name ?? 'Not Assigned' }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">{{ $church->archid->name ?? 'Not Assigned' }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @if($church->is_active)
                            ...
                            @empty
                            <tr>
                                <td colspan="5" class="px-6 py-4 text-center text-gray-500">No churches found</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
