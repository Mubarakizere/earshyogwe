                ...
                <form action="{{ route('workers.store') }}" method="POST" enctype="multipart/form-data" class="p-8">
                    ...
                    <div class="space-y-8">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600 mb-4">Upload employment documents (contracts, certificates, etc.). Accepted: PDF, Word (DOC/DOCX), Images (JPG/PNG/GIF). Max size: 20MB per file.</p>
