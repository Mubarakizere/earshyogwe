<x-app-layout>
                            ...
                            <div class="space-y-2">
                                @foreach($worker->documents as $document)
                                    <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                        ...
                                        <button type="button" 
                                            @click="$dispatch('open-delete-modal', { id: {{ $document->id }} })"
    ...
    <!-- Delete Document Confirmation Modal (MOVED OUTSIDE MAIN FORM) -->
    @if($worker->documents->count() > 0)
    <div x-data="{ deleteDocId: null, deleteDocOpen: false }" 
         @open-delete-modal.window="deleteDocId = $event.detail.id; deleteDocOpen = true">
