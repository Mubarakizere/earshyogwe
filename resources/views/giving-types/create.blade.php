                            ...
                            <div class="flex items-start">
                                ...
                                <div class="ml-3">
                                    ...
                                    <p class="text-sm text-gray-600">
                                        Check this if you want to add sub-categories under this giving type (e.g., "Offerings" can have "Sunday Offering", "Thanksgiving Offering", etc.)
                                    </p>
                                </div>
                            </div>
                        </div>
