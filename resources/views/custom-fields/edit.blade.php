<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-2xl text-gray-800 leading-tight">Edit Custom Field</h2>
    </x-slot>

    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl rounded-lg p-8">
                <form action="{{ route('custom-fields.update', $customField) }}" method="POST" x-data="{ fieldType: '{{ $customField->field_type }}' }">
                    @csrf
                    @method('PUT')
