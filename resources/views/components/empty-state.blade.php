@props(['title', 'message', 'action' => null, 'url' => '#', 'icon' => 'folder'])

<div class="text-center py-12 bg-white rounded-lg shadow-sm border border-gray-100">
    <div class="mx-auto h-12 w-12 text-gray-400 bg-gray-50 rounded-full flex items-center justify-center mb-4">
        @if($icon === 'folder')
            <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 19a2 2 0 01-2-2V7a2 2 0 012-2h4l2 2h4a2 2 0 012 2v1M5 19h14a2 2 0 002-2v-5a2 2 0 00-2-2H9a2 2 0 00-2 2v5a2 2 0 01-2 2z"></path></svg>
        @elseif($icon === 'users')
        ...
        @else
            <!-- Default or Custom SVG passed in slot? For simplicity, generic folder -->
